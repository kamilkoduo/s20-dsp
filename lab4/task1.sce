...
figure(0)
plot(s) 
xlabel("Time, n", 'fontsize', 3)
ylabel("Amplitude", 'fontsize', 3)
title("Signal with noise in time domain", 'fontsize', 4)
...
xlabel("Frequency component, n", 'fontsize', 3)
ylabel("Freq Amplitude", 'fontsize', 3)
title("Signal with noise in frequency domain", 'fontsize', 4)
...
H_l = ideal_lowpass(2000, 0.15, 0.); // Filter will have length 2001
hl_len = length(H_l)
...
ylabel("Freq amplitude", 'fontsize', 3)
title("Frequency response of ideal low-pass filter", 'fontsize', 4)
...
figure(3)
plot2d("nn", frequencies, H_h, color("blue")) // plot
xlabel("Frequency, Hz", 'fontsize', 3)
ylabel("Freq amplitude", 'fontsize', 3)
title("Frequency response of ideal high-pass filter", 'fontsize', 4)
...
xlabel("Time, n", 'fontsize', 3)
ylabel("Amplitude", 'fontsize', 3)
title("Impulse response of ideal low-pass filter", 'fontsize', 4)
...
xlabel("Time, n", 'fontsize', 3)
ylabel("Amplitude", 'fontsize', 3)
title("Impulse response of ideal high-pass filter", 'fontsize', 4)
//xs2png(gcf(), PLOTS + "ideal_lowpass_time.png")
//close()
...
xlabel("Time, n", 'fontsize', 3)
ylabel("Amplitude", 'fontsize', 3)
title("Windowed impulse response of ideal low-pass filter", 'fontsize', 4)
...
xlabel("Time, n", 'fontsize', 3)
ylabel("Amplitude", 'fontsize', 3)
title("Windowed impulse response of ideal high-pass filter", 'fontsize', 4)
...
xlabel("Time, n", 'fontsize', 3)
ylabel("Amplitude", 'fontsize', 3)
title("Frequency response of the final lowpass FIR filter", 'fontsize', 4)
...
xlabel("Time, n", 'fontsize', 3)
ylabel("Amplitude", 'fontsize', 3)
title("Frequency response of the final highpass FIR filter", 'fontsize', 4)
//xs2png(gcf(), PLOTS + "freq_resp_FIR_Filter.png")
//close()
...
savewave(RESULTS + "filtered", con, Fs)
figure(10)
clf()
plot2d("nl", s_frequencies, abs(fft(s)), color("blue"))
plot2d("nl", c_frequencies, fft(con), color("red"))
xlabel("Frequency, Hz", 'fontsize', 3)
ylabel("Frquency amplitude", 'fontsize', 3)
title("Result of filtering", 'fontsize', 4)
